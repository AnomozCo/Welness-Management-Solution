...
$productResult = $db_handle->runQuery("select * from wel_users order by id desc");
...
<h2 style="text-align:center;">Software Users Data</h2>

<div id="table-container">
    <div class="btn">
        <button onclick="exportTableToExcel('tab', 'HU-software-users')" id="btnExport" name='export'
    ...
    <table id="tab">
        ...
        <tbody>
            ...
            if (! empty($productResult)) {
                ...
                <td><?php echo $productResult[$key]["role"]; ?></td>
            </tr>
           <?php
                }
            }
