...
$productResult = $db_handle->runQuery("select * from wel_bookings b inner join lib_students s on b.studentId= s.cardnumber where b.category='gym' order by b.id desc");
...
<h2 style="text-align:center;">Gym Signins Data</h2>

<div id="table-container">
    <div class="btn">
        <button onclick="exportTableToExcel('tab', 'HU-gym-signins')" id="btnExport" name='export'
