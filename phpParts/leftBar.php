    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item <?if($filename=="poolhistory.php"){echo "active";}?>">
            <a class="nav-link" href="./poolhistory.php">
              <i class="material-icons">library_books</i>
              <p>Pool Signins</p>
            </a>
          </li>
          <li class="nav-item <?if($filename=="gymhistory.php"){echo "active";}?>">
            <a class="nav-link" href="./gymhistory.php">
              <i class="material-icons">library_books</i>
              <p>Gym Signins</p>
            </a>
          </li>
