...
$query = "select*from wel_students s inner join wel_bookings b on s.cardnumber = b.studentId where b.category='pool' order by b.id desc"; 
            ...
            -->
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <h4 class="card-title ">Past Pool Signins</h4>
                  <p class="card-category">Find all the past Pool Signins here</p>
                </div>
                <div class="card-body">
